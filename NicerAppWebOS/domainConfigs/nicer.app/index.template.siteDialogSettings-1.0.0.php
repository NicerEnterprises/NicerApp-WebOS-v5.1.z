...
{$div_siteContent}    
    ...
    <div class="vividDialogContent vividScrollpane">
        <div class="navbar">
            <!--<img src="/NicerAppWebOS/siteMedia/btnSettingsBorder.png"/>-->
            <div id="btnViewResult" class="vividButton_icon_50x50_nateNav tooltip" title="View result" alt="View result" onclick="if (!$(this).is('.disabled')) { if (!na.desktop.settings.visibleDivs.includes('#siteContent'))  na.desktop.settings.visibleDivs.push('#siteContent'); na.desktop.settings.visibleDivs.remove('#siteToolbarThemeEditor'); na.site.settings.activeDivs=['#siteContent']; na.desktop.resize();}">
                ...
                <img class="vividButton_icon_imgTile_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton.green2a.png"/>
                <img class="vividButton_icon_imgButtonIcon_50x50" src="/NicerAppWebOS/siteMedia/btnBack.png" style="position:absolute;top:10px;left:10px;width:64px;height:64px;"/>
            </div>
            <div id="btnSelectBorderSettings" class="vividButton_icon_50x50_nateNav tooltip" title="Select border settings" alt="Select border settings"  onclick="if (!$(this).is('.disabled')) na.themeEditor.selectBorderSettings(event)">
                <div class="vividButton_icon_borderCSS_50x50"></div>
                <!--<img class="vividButton_icon_imgTile_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton.grey2a.png"/>-->
                <img class="vividButton_icon_imgButtonIcon_50x50" src="/NicerAppWebOS/siteMedia/btnSettingsBorder3.png"/>
            </div>
            <div id="btnSelectBackgroundColor" class="vividButton_icon_50x50_nateNav tooltip" title="Select background color" alt="Select background color"  onclick="if (!$(this).is('.disabled')) na.themeEditor.selectBackground_color(event)">
                <div class="vividButton_icon_borderCSS_50x50"></div>
                <img class="vividButton_icon_imgTile_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton.yellow1a.png"/>
                <img class="vividButton_icon_imgButtonIcon_50x50" src="/NicerAppWebOS/siteMedia/btnColorPicker.png" style="position:absolute;top:10px;left:10px;width:64px;height:64px;"/>
            </div>
            <div id="btnSelectBackgroundFolder" class="vividButton_icon_50x50_nateNav tooltip" title="Select background image folder" alt="Select background image folder" onclick="if (!$(this).is('.disabled')) na.themeEditor.selectBackground_folder(event)">
                <div class="vividButton_icon_borderCSS_50x50"></div>
                <img class="vividButton_icon_imgTile_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton.yellow1b.png"/>
                <img class="vividButton_icon_imgButtonIcon_50x50" src="/NicerAppWebOS/siteMedia/fileTree_1b.png" style="position:absolute;top:5px;left:5px;width:74px;height:74px;"/>
            </div>
            <div id="btnSelectBackgroundImage" class="vividButton_icon_50x50_nateNav tooltip" title="Select background image" alt="Select background image"  onclick="if (!$(this).is('.disabled')) na.themeEditor.selectBackground_image(event)">
                <div class="vividButton_icon_borderCSS_50x50"></div>
                <img class="vividButton_icon_imgTile_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton.yellow1a.png"/>
                <img class="vividButton_icon_imgButtonIcon_50x50" src="/NicerAppWebOS/siteMedia/btnBackground.png" style="position:absolute;top:5px;left:5px;width:74px;height:74px;"/>
            </div>
            <div id="btnSelectTextSettings" class="vividButton_icon_50x50_nateNav tooltip" title="Select text settings" alt="Select text settings"  onclick="if (!$(this).is('.disabled')) na.themeEditor.selectTextSettings(event)">
                <div class="vividButton_icon_borderCSS_50x50"></div>
                <img class="vividButton_icon_imgTile_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton.yellow1a.png"/>
                <img class="vividButton_icon_imgButtonIcon_50x50" src="/NicerAppWebOS/siteMedia/btnSettingsText.png" style="position:absolute;top:10px;left:10px;width:64px;height:64px;"/>
            </div>
        </div>
        ...
        <div id="specificitySettings" class="themeEditorComponent_alwaysVisible" style="padding:0;margin:0;font-size:22px;flex-wrap:wrap;">
            ...
            <div id="btnDeleteSpecificity" class="vividButton_icon_50x50 tooltip" title="Delete all cosmetic settings for this specificity" alt="Delete all cosmetic settings for this specificity" onclick="if (!$(this).is('.disabled')) na.te.deleteSpecificity(event)" style="order:1;margin-left:auto;vertical-align:middle;width:70px;height:70px;position:relative;display:inline-block">
                ...
                <img class="vividButton_icon_imgBorder_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton_outerBorder.png" style="width:70px;height:70px;"/>
                <img class="vividButton_icon_imgTile_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton.png" style="width:70px;height:70px;"/>
                <img class="vividButton_icon_imgButtonIcon_50x50" src="/NicerAppWebOS/siteMedia/iconDelete.png" style="position:absolute;top:7px;left:7px;width:56px;height:56px;"/>
            </div>
            ...
            <div id="btnSetPermissionsForTheme" class="vividButton_icon_50x50 tooltip" title="Create or delete theme, and set permissions for current theme" alt="Create or delete theme, and set permissions for this theme" onclick="if (!$(this).is('.disabled')) na.te.setPermissionsForTheme(event)" style="order:2;margin-left:auto;vertical-align:middle;width:70px;height:70px;position:relative;display:inline-block">
                <div class="vividButton_icon_borderCSS_50x50" style="width:70px;height:70px;"></div>
                <!--<img class="vividButton_icon_imgBorder_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton_outerBorder.png" style="width:70px;height:70px;"/>-->
                <img class="vividButton_icon_imgTile_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton.red1b.png" style="width:70px;height:70px;"/>
                <img class="vividButton_icon_imgButtonIcon_50x50" src="/NicerAppWebOS/siteMedia/1660_blk_19329_zoom.upperBodyOnly.256x256.png" style="position:absolute;top:7px;left:7px;width:56px;height:56px;z-index:2020;"/>
                <img class="vividButton_icon_imgButtonIcon_50x50_sup1" src="/NicerAppWebOS/siteMedia/btnTrashcan2_white_lowres.png" style="position:absolute;width:15px;height:19px;z-index:2021;"/>
                <img class="vividButton_icon_imgButtonIcon_50x50_sup2" src="/NicerAppWebOS/siteMedia/documentAdd_lowres.png" style="position:absolute;left:50px;width:20px;height:20px;z-index:2021;"/>
        ...
        <div id="borderSettings" class="themeEditorComponent vividScrollpane" style="top:auto;">
            ...
            <div id="boxShadow">
                <img src="/NicerAppWebOS/siteMedia/iconCreate.png" onclick="na.te.addBoxShadow()"/>
                <img src="/NicerAppWebOS/siteMedia/iconDelete.png" onclick="na.te.deleteBoxShadow()"/>
        ...
        <div id="textSettings" class="themeEditorComponent vividScrollpane" style="position:absolute;top:auto;display:none;">
            ...
            <div id="textShadow">
                <img src="/NicerAppWebOS/siteMedia/iconCreate.png" onclick="na.te.addTextShadow(event)"/>
                <img src="/NicerAppWebOS/siteMedia/iconDelete.png" onclick="na.te.deleteTextShadow(event)"/>
                <div class="flexBreak"></div>
    ...
    <div id="btnOptions" class="vividButton_icon_50x50_siteTop" style="width:50px;height:50px;" onclick="na.site.onclick_btnOptions()">
        <div class="vividButton_icon_borderCSS_50x50"></div>
        <img class="vividButton_icon_imgBorder_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton_outerBorder.png"/>
        <img class="vividButton_icon_imgTile_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton.png"/>
        <img class="vividButton_icon_imgButtonIcon_50x50" src="/NicerAppWebOS/siteMedia/btnOptions2.png"/>
    </div>
    ...
    <div id="btnLoginLogout" class="vividButton_icon_50x50_siteTop" style="width:50px;height:50px;" onclick="na.site.displayLogin()">
        ...
        <img class="vividButton_icon_imgBorder_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton_outerBorder.png"/>
        <img class="vividButton_icon_imgTile_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton.png"/>
        <img class="vividButton_icon_imgButtonIcon_50x50" src="/NicerAppWebOS/siteMedia/btnLogin2.png"/>
    </div>
    ...
    <div id="btnChangeBackground" class="vividButton_icon_50x50_siteTop" style="width:50px;height:50px;" onclick="na.site.changeBackground()">
        ...
        <img class="vividButton_icon_imgBorder_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton_outerBorder.png"/>
        <img class="vividButton_icon_imgTile_50x50" src="/NicerAppWebOS/siteMedia/btnCssVividButton.png"/>
        <img class="vividButton_icon_imgButtonIcon_50x50" src="/NicerAppWebOS/siteMedia/btnBackground.png"/>
    </div>
