<li id="subMenu__new-background" class="subMenu"><a class="noPushState" href="javascript:na.backgrounds.next('#siteBackground');">Background</a>
    <ul>
        ...
        <li><a class="noPushState" href="javascript:na.backgrounds.next('#siteBackground', nicerapp.site.themes.groups.guests.calculate.stages[0].backgrounds.favorites.onlyCGI);">CGI</a>
            <! - - see .../NicerAppWebOS/siteMedia/iframe/webgl -- >
            <ul>
        ...
        <li><a class="noPushState" href="javascript:na.backgrounds.next('#siteBackground', 'landscape');">Landscape</a>
            ...
            <li><a class="noPushState" href="javascript:na.backgrounds.next('#siteBackground', 'landscape favorites');">Favorites</a>
        ...
        <li><a class="noPushState" href="javascript:na.backgrounds.next('#siteBackground', 'portrait');">Portrait</a>
            <ul>
            <li><a class="noPushState" href="javascript:na.backgrounds.next('#siteBackground', 'portrait favorites');">Favorites</a>
        ...
        <!--
        <li><a class="noPushState" href="javascript:na.backgrounds.next('#siteContent');">For Content</a>
            <ul>
            ...
            <li><a class="noPushState" href="javascript:na.backgrounds.next('#siteContent', nicerapp.site.themes.groups.guests.calculate.stages[0].backgrounds.favorites.onlyCGI);">CGI</a>
                <ul>
                    <li><a class="noPushState" href="javascript:na.backgrounds.next('#siteContent', nicerapp.site.themes.groups.guests.calculate.stages[0].backgrounds.favorites.onlyCGI, '2D');">2D CGI</a></li>
                    <li><a class="noPushState" href="javascript:na.backgrounds.next('#siteContent', nicerapp.site.themes.groups.guests.calculate.stages[0].backgrounds.favorites.onlyCGI, '3D');">3D CGI</a></li>
                </ul>
