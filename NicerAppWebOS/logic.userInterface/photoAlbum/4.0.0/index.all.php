...
<head>
    <link type="text/css" rel="StyleSheet" href="/NicerAppWebOS/domainConfigs/said.by/index.css?c=<?php echo date('Ymd_His');?>">
    <link type="text/css" rel="StyleSheet" href="/NicerAppWebOS/domainConfigs/said.by/index.dark.css?c=<?php echo date('Ymd_His');?>">
    <style>
        .filename {
            color : white;
        }
