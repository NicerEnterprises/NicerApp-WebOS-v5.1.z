...
<link type="text/css" rel="StyleSheet" href="/NicerAppWebOS/domainConfigs/nicer.app/index.css?c=<?php echo date('Ymd_His',filemtime(realpath(dirname(__FILE__).'/../../../').'/domainConfigs/nicer.app/index.css'))?>">
<link type="text/css" rel="StyleSheet" href="/NicerAppWebOS/domainConfigs/nicer.app/index.dark.css?c=<?php echo date('Ymd_His',filemtime(realpath(dirname(__FILE__).'/../../../').'/domainConfigs/nicer.app/index.dark.css'))?>">
