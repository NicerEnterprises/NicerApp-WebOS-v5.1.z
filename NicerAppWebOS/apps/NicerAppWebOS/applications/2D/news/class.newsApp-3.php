...
class newsApp3_class {
    ...
    public function checkIPrange() {
        ...
        // to : Humanity that's native to Earth
        ...
        and surgery here requires tactical and strategic strikes against the enemies. not to anger them, to warn them of the possible consequences of attacking the foundations that we spent centuries building (our Western countries and all the buildings in them, each down to the plumbing and gas-lines in our streets, and our own populations {native and migrant properly mixed together} that inhabit *those* areas on the globe. our own areas.).
